(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,37986,e=>{"use strict";let t=[{id:"1",slug:"top-5-lgbtq-bars-shinjuku-nichome",title:{en:"Top 5 LGBTQ+ Bars in Shinjuku Nichome: A Complete Guide",jp:"新宿二丁目のおすすめLGBTQ+バー5選：完全ガイド"},excerpt:{en:"Discover the best LGBTQ+ friendly bars in Tokyo's most vibrant district. From cozy cocktail lounges to energetic dance clubs, find your perfect spot in Shinjuku Nichome.",jp:"東京で最も活気あるエリア、新宿二丁目のLGBTQ+フレンドリーなバーを発見しましょう。居心地の良いカクテルラウンジからエネルギッシュなダンスクラブまで、新宿二丁目で完璧な場所を見つけてください。"},content:{en:`Shinjuku Nichome is the heart of Tokyo's LGBTQ+ community, boasting over 300 bars and clubs in just a few blocks. As someone who has spent countless nights exploring this vibrant district, I'm excited to share my top picks for the best LGBTQ+ bars in the area.
...
Remember, Shinjuku Nichome is more than just a nightlife district - it's a community, a safe space, and a celebration of diversity. Whether you're a local or a visitor, you're sure to find warmth, acceptance, and unforgettable experiences in this vibrant corner of Tokyo.`,jp:`新宿二丁目は東京のLGBTQ+コミュニティの中心地で、わずか数ブロックに300以上のバーやクラブが集まっています。この活気あるエリアを何度も探索してきた者として、この地域で最高のLGBTQ+バーのおすすめを共有できることを嬉しく思います。
...
覚えておいてください、新宿二丁目は単なるナイトライフ地区ではありません - それはコミュニティ、安全な空間、多様性の祝賀です。地元の人でも訪問者でも、東京のこの活気ある一角で温かさ、受容、忘れられない体験を見つけることでしょう。`},date:"2023-10-15",image:"/photo/t-a/IMG_9560.JPG",tags:["lgbtq-friendly","nightlife","tokyo","travel-guide","tips"],author:{name:{en:"Taka & Ady",jp:"Taka & Ady"},role:{en:"Co-Founders & Guides",jp:"共同創業者 & ガイド"}}},{id:"2",slug:"our-wedding-experience-kyoto",title:{en:"Our Wedding Experience in Kyoto: A Dream Come True",jp:"京都でのウェディング体験記：夢が叶った瞬間"},excerpt:{en:"Join us as we share our intimate wedding journey in the ancient capital of Japan. From traditional ceremonies to modern celebrations, discover how we created our perfect day.",jp:"日本の古都での親密なウェディングの旅を共有します。伝統的な儀式から現代的な祝賀まで、完璧な一日をどのように作ったかを発見してください。"},content:{en:`When we decided to get married, there was never any doubt in our minds that Kyoto would be the perfect setting for our special day. As two people deeply connected to Japanese culture and each other, we wanted a wedding that would honor both tradition and our unique love story. What followed was an experience that exceeded all our expectations and created memories we'll cherish forever.
...
Looking back on that day, we're filled with gratitude - for the beautiful setting, for the supportive community, for our amazing guests, and most of all, for each other. Our wedding in Kyoto wasn't just a day; it was the beginning of a new chapter in our lives, one that we'll continue to write together with love, respect, and a deep appreciation for the culture that brought us together.`,jp:`結婚を決めたとき、京都が私たちの特別な日に完璧な場所になることは、私たちの心の中に疑いの余地がありませんでした。日本の文化とお互いに深くつながっている2人として、伝統と私たちのユニークな愛の物語の両方を尊重する結婚式を望んでいました。その結果、すべての期待を超え、永遠に大切にする思い出を作る体験となりました。
...
その日を振り返ると、私たちは感謝で満たされています - 美しい設定、支持的なコミュニティ、素晴らしいゲスト、そして何よりも、お互いのために。京都での私たちの結婚式は単なる日ではありませんでした。それは私たちの人生の新しい章の始まりであり、愛、尊敬、そして私たちを結びつけた文化への深い感謝と共に、一緒に書き続けるものです。`},date:"2023-09-20",image:"/photo/wedding/IMG_3117.JPG",tags:["wedding","kyoto","culture","photography","lgbtq-friendly"],author:{name:{en:"Taka & Ady",jp:"Taka & Ady"},role:{en:"Co-Founders",jp:"共同創業者"}}},{id:"3",slug:"interview-taka-ady",title:{en:"Interview with Taka & Ady: Building Japan Pride Journeys",jp:"Taka & Ady インタビュー：Japan Pride Journeysの構築"},excerpt:{en:"Get to know the founders behind Japan Pride Journeys. Learn about their vision, challenges, and dreams for creating safe and memorable experiences for the LGBTQ+ community in Japan.",jp:"Japan Pride Journeysの背後にある創業者を知ってください。日本でLGBTQ+コミュニティのための安全で記憶に残る体験を作るための彼らのビジョン、挑戦、夢について学びます。"},content:{en:`Starting a business is never easy, but starting a business focused on serving the LGBTQ+ community in a country where same-sex marriage isn't yet legally recognized presents unique challenges and opportunities. This is the story of Taka and Ady, the founders of Japan Pride Journeys, and their mission to create safe, authentic, and unforgettable travel experiences for LGBTQ+ visitors to Japan.
...
日本への旅行を検討しているLGBTQ+旅行者にとって、TakaとAdyの物語はインスピレーションと実践的なガイダンスの両方を提供します。彼らの旅は、適切なビジョン、適切なチーム、適切なコミットメントがあれば、楽しいだけでなく変革的な体験を作成できることを証明しています。そして、旅行が人々を結びつけ、理解を作り出す力信じる人にとって、Japan Pride Journeysは注目に値する - そしてサポートする - 会社です。`},date:"2023-08-10",image:"/photo/t-a/IMG_0326.JPG",tags:["community","culture","lgbtq-friendly","tips"],author:{name:{en:"Japan Pride Journeys",jp:"Japan Pride Journeys"},role:{en:"Editorial Team",jp:"編集チーム"}}},{id:"4",slug:"kyoto-temples-lgbtq-friendly-guide",title:{en:"Kyoto Temples: An LGBTQ+ Friendly Guide to Spiritual Sites",jp:"京都の寺院：LGBTQ+フレンドリーな聖地ガイド"},excerpt:{en:"Explore Kyoto's most beautiful temples and shrines with confidence. Our guide highlights LGBTQ+ friendly spiritual sites and provides tips for respectful visits.",jp:"自信を持って京都で最も美しい寺院と神社を探索してください。私たちのガイドはLGBTQ+フレンドリーな聖地を強調し、敬意を払った訪問のためのヒントを提供します。"},content:{en:`Kyoto, Japan's ancient capital, is home to over 2,000 temples and shrines, each offering a unique glimpse into Japan's rich spiritual and cultural heritage. For LGBTQ+ travelers, visiting these sacred sites can be both inspiring and intimidating. Will we be welcomed? Are there specific customs we need to follow? How can we respectfully engage with these ancient traditions while being true to ourselves?
...
京都の寺院や神社は、古代の伝統に従事しながら自分自身でいられる空間を提供します。それらは、アイデンティティに関係なく、すべての人に開放されている精神的成長、文化的理解、個人的反省の機会を提供します。敬意、好奇心、そして開かれた心を持って、これらの聖地への訪問は、日本への旅の中で最も意味のある体験の一つになる可能性があります。`},date:"2023-07-25",image:"/photo/t-a/IMG_1365.JPG",tags:["kyoto","culture","travel-guide","lgbtq-friendly","safety"],author:{name:{en:"Taka & Ady",jp:"Taka & Ady"},role:{en:"Co-Founders & Guides",jp:"共同創業者 & ガイド"}}},{id:"5",slug:"tokyo-shibuya-scramble-lgbtq-nightlife",title:{en:"Beyond Shibuya Scramble: LGBTQ+ Nightlife in Tokyo's Trendiest District",jp:"渋谷スクランブルを超えて：東京の最もトレンディな地区でのLGBTQ+ナイトライフ"},excerpt:{en:"Discover the vibrant LGBTQ+ nightlife scene in Shibuya, Tokyo's fashion and entertainment hub. From hidden bars to popular clubs, explore the diverse nightlife options.",jp:"東京のファッションとエンターテインメントの中心地である渋谷の活気あるLGBTQ+ナイトライフシーンを発見してください。隠れたバーから人気のクラブまで、多様なナイトライフオプションを探索します。"},content:{en:`Shibuya is synonymous with Tokyo's cutting-edge culture, fashion, and nightlife. While most visitors know it for the famous Shibuya Scramble Crossing and the Hachiko statue, this vibrant district offers much more, especially for LGBTQ+ travelers seeking authentic nightlife experiences. As someone who has spent countless nights exploring Shibuya's diverse entertainment scene, I'm excited to share insights that will help you discover the best LGBTQ+ friendly venues in this dynamic area.
...
The key to enjoying Shibuya's LGBTQ+ nightlife is to be open, respectful, and yourself. The area's diverse and inclusive atmosphere makes it a welcoming place for LGBTQ+ travelers, and with a little planning and an adventurous spirit, you're sure to have an unforgettable night out in one of Tokyo's most dynamic districts.`,jp:`渋谷は東京の最先端の文化、ファッション、ナイトライフと同義です。ほとんどの訪問者は有名な渋谷スクランブル交差点とハチ公像で知っていますが、この活気ある地区は、特に本格的なナイトライフ体験を求めるLGBTQ+旅行者にとって、はるかに多くのものを提供します。渋谷の多様なエンターテインメントシーンを何度も探索してきた者として、このダイナミックなエリアで最高のLGBTQ+フレンドリーな会場を発見するのに役立つ洞察を共有できることを嬉しく思います。
...
渋谷のLGBTQ+ナイトライフを楽しむ鍵は、オープンで、敬意を持ち、自分自身であることです。エリアの多様で包括的な雰囲気は、LGBTQ+旅行者にとって歓迎的な場所を作り出し、少しの計画と冒険的な精神で、東京で最もダイナミックな地区の一つで忘れられない夜を過ごすことでしょう。`},date:"2023-06-15",image:"/photo/t-a/IMG_1814.JPG",tags:["tokyo","nightlife","lgbtq-friendly","travel-guide","community"],author:{name:{en:"Taka & Ady",jp:"Taka & Ady"},role:{en:"Co-Founders & Guides",jp:"共同創業者 & ガイド"}}},{id:"6",slug:"osaka-lgbtq-friendly-travel-guide",title:{en:"Osaka: A Comprehensive LGBTQ+ Friendly Travel Guide",jp:"大阪：包括的なLGBTQ+フレンドリーな旅行ガイド"},excerpt:{en:"Explore Osaka's welcoming atmosphere, vibrant food scene, and LGBTQ+ friendly venues. Discover why this city is becoming a favorite destination for LGBTQ+ travelers.",jp:"大阪の歓迎的な雰囲気、活気あるフードシーン、LGBTQ+フレンドリーな会場を探索してください。この都市がLGBTQ+旅行者のお気に入りの目的地になりつつある理由を発見してください。"},content:{en:`Osaka, Japan's second-largest city, is often overshadowed by Tokyo and Kyoto in travel guides, but this vibrant metropolis offers a unique and welcoming experience for LGBTQ+ travelers. Known for its friendly locals, incredible food scene, and more relaxed atmosphere compared to Tokyo, Osaka is quickly becoming a favorite destination for LGBTQ+ visitors seeking authentic Japanese experiences.
...
LGBTQ+旅行者として大阪を楽しむ鍵は、オープンで、敬意を持ち、自分自身であることです。都市の歓迎的な雰囲気、友好的な地元の人々、多様な魅力は、本格的な日本の体験を求めるLGBTQ+旅行者にとって理想的な目的地にします。少しの計画と冒険的な精神で、この素晴らしい都市への忘れられない訪問をすることでしょう。`},date:"2023-05-20",image:"/photo/t-a/IMG_1895.JPG",tags:["osaka","travel-guide","lgbtq-friendly","food","culture"],author:{name:{en:"Taka & Ady",jp:"Taka & Ady"},role:{en:"Co-Founders & Guides",jp:"共同創業者 & ガイド"}}},{id:"7",slug:"japanese-food-culture-lgbtq-travelers",title:{en:"Japanese Food Culture: A Guide for LGBTQ+ Travelers",jp:"日本の食文化：LGBTQ+旅行者のためのガイド"},excerpt:{en:"Explore Japan's incredible food scene with confidence. From izakaya to fine dining, learn how to navigate Japanese restaurants as an LGBTQ+ traveler.",jp:"自信を持って日本の信じられないほどのフードシーンを探索してください。居酒屋から高級レストランまで、LGBTQ+旅行者として日本のレストランをナビゲートする方法を学びます。"},content:{en:`Japanese cuisine is renowned worldwide for its emphasis on fresh ingredients, meticulous preparation, and beautiful presentation. For LGBTQ+ travelers visiting Japan, exploring the country's food culture can be one of the most rewarding aspects of the journey. However, navigating restaurants, understanding dining customs, and feeling comfortable in food establishments can sometimes feel daunting, especially when you're not sure how welcoming these spaces will be.
...
The key to enjoying Japanese food culture as an LGBTQ+ traveler is to be open, respectful, and curious. Japanese restaurants are generally welcoming spaces where the focus is on providing excellent food and service to all guests. With a little knowledge of dining etiquette and an adventurous spirit, you're sure to have incredible culinary experiences that will be among the highlights of your journey to Japan.`,jp:`日本料理は、新鮮な食材への重点、細心の準備、美しいプレゼンテーションで世界的に有名です。日本を訪れるLGBTQ+旅行者にとって、国の食文化を探索することは、旅の中で最も報酬のある側面の一つになる可能性があります。しかし、レストランをナビゲートし、食事の習慣を理解し、飲食店で快適に感じることは、特にこれらの空間がどれほど歓迎的かわからない場合、時々威圧的に感じる可能性があります。
...
LGBTQ+旅行者として日本の食文化を楽しむ鍵は、オープンで、敬意を持ち、好奇心旺盛であることです。日本のレストランは一般的に歓迎的な空間で、すべてのゲストに優れた食べ物とサービスを提供することに焦点を当てています。食事のエチケットの少しの知識と冒険的な精神で、あなたは日本への旅のハイライトの一つになる信じられないほどの料理体験をすることでしょう。`},date:"2023-04-12",image:"/photo/t-a/IMG_3705.JPG",tags:["food","culture","travel-guide","tips"],author:{name:{en:"Taka & Ady",jp:"Taka & Ady"},role:{en:"Co-Founders & Guides",jp:"共同創業者 & ガイド"}}},{id:"8",slug:"safety-tips-lgbtq-travelers-japan",title:{en:"Safety Tips for LGBTQ+ Travelers in Japan",jp:"日本でのLGBTQ+旅行者のための安全のヒント"},excerpt:{en:"Essential safety advice for LGBTQ+ travelers visiting Japan. Learn about local laws, cultural considerations, and how to stay safe while being yourself.",jp:"日本を訪れるLGBTQ+旅行者のための必須の安全アドバイス。地元の法律、文化的考慮事項、そして自分らしくいながら安全を保つ方法について学びます。"},content:{en:`Traveling as an LGBTQ+ person requires additional considerations, and Japan is no exception. While Japan is generally a safe country with low crime rates, understanding the legal landscape, cultural context, and practical safety tips can help ensure a positive and secure experience. Having guided many LGBTQ+ travelers through Japan, I want to share essential safety information that will help you navigate your journey with confidence.
...
東京での素晴らしいカップルの写真の鍵は、自分らしくいることに快適さを感じる場所を見つけることです。都市は無数の美しいスポットを提供します。伝統的な庭園から現代的な展望台まで、静かな近隣から活気ある通りまで。少しの計画と適切な場所で、何年も大切にする美しい思い出を確実に捉えることでしょう。`},date:"2023-02-14",image:"/photo/t-a/IMG_6210.JPG",tags:["photography","tokyo","lgbtq-friendly","tips"],author:{name:{en:"Taka & Ady",jp:"Taka & Ady"},role:{en:"Co-Founders & Photographers",jp:"共同創業者 & 写真家"}}},{id:"10",slug:"japan-pride-festivals-events-guide",title:{en:"Japan Pride Festivals and Events: A Complete Guide",jp:"日本のプライドフェスティバルとイベント：完全ガイド"},excerpt:{en:"Discover Japan's vibrant Pride festivals and LGBTQ+ events. From Tokyo Rainbow Pride to local celebrations, learn about the best events to attend.",jp:"日本の活気あるプライドフェスティバルとLGBTQ+イベントを発見してください。東京レインボープライドから地元の祝賀まで、参加するのに最適なイベントについて学びます。"},content:{en:`Japan's LGBTQ+ community is vibrant and active, with numerous Pride festivals and events held throughout the year across the country. For LGBTQ+ travelers visiting Japan, these events offer wonderful opportunities to connect with the local community, celebrate diversity, and experience Japan's growing LGBTQ+ culture. Having attended and participated in many of these events, I'm excited to share a comprehensive guide to Japan's Pride festivals and LGBTQ+ events.
...
The key to enjoying Japan's Pride festivals and events is to be open, respectful, and engaged. These events offer wonderful opportunities to experience Japan's LGBTQ+ culture, connect with the local community, and celebrate diversity in a supportive, welcoming environment. Whether you're attending your first Pride event or are a seasoned Pride-goer, Japan's LGBTQ+ events offer unique experiences that you'll remember for years to come.`,jp:`日本のLGBTQ+コミュニティは活気があり活動的で、一年を通じて全国で多数のプライドフェスティバルとイベントが開催されています。日本を訪れるLGBTQ+旅行者にとって、これらのイベントは地元コミュニティとつながり、多様性を祝い、日本の成長しているLGBTQ+文化を体験する素晴らしい機会を提供します。これらのイベントの多くに参加し、参加してきた後、日本のプライドフェスティバルとLGBTQ+イベントの包括的なガイドを共有できることを嬉しく思います。
...
日本のプライドフェスティバルとイベントを楽しむ鍵は、オープンで、敬意を持ち、従事することです。これらのイベントは、日本のLGBTQ+文化を体験し、地元コミュニティとつながり、支援的で歓迎的な環境で多様性を祝う素晴らしい機会を提供します。初めてのプライドイベントに参加する場合でも、経験豊富なプライド参加者でも、日本のLGBTQ+イベントは、何年も覚えているユニークな体験を提供します。`},date:"2023-01-25",image:"/photo/t-a/IMG_6592.JPG",tags:["events","community","lgbtq-friendly","culture"],author:{name:{en:"Taka & Ady",jp:"Taka & Ady"},role:{en:"Co-Founders & Community Organizers",jp:"共同創業者 & コミュニティオーガナイザー"}}}];e.s(["POSTS_PER_PAGE",0,10,"blogPosts",0,t,"blogTags",0,{en:{"lgbtq-friendly":"LGBTQ+ Friendly","travel-guide":"Travel Guide",culture:"Culture",nightlife:"Nightlife",wedding:"Wedding",tokyo:"Tokyo",kyoto:"Kyoto",osaka:"Osaka",food:"Food",photography:"Photography",community:"Community",safety:"Safety",tips:"Tips",events:"Events",accommodation:"Accommodation"},jp:{"lgbtq-friendly":"LGBTQ+フレンドリー","travel-guide":"旅行ガイド",culture:"文化",nightlife:"ナイトライフ",wedding:"ウェディング",tokyo:"東京",kyoto:"京都",osaka:"大阪",food:"グルメ",photography:"フォトグラフィー",community:"コミュニティ",safety:"安全",tips:"ヒント",events:"イベント",accommodation:"宿泊施設"}}])}]);